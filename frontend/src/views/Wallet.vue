    ...
    <section class="wallet-content">
      ...
      <section class="summary-grid">
        <article class="balance-card">
          <div><span>当前 EDU 余额</span><strong>120 <em>EDU</em></strong><p><i></i> 注册奖励 +100 EDU</p></div>
          <svg viewBox="0 0 24 24"><path d="M4 7h15a2 2 0 0 1 2 2v10H4a2 2 0 0 1-2-2V5a2 2 0 0 0 2 2Z" /><path d="M16 13h4" /></svg>
        </article>
        <article class="info-card"><span class="round user"><svg viewBox="0 0 24 24"><circle cx="12" cy="8" r="4" /><path d="M4 21a8 8 0 0 1 16 0" /></svg></span><p>用户名</p><strong>张三</strong><small>学号：20240001</small></article>
        <article class="info-card"><span class="round link"><svg viewBox="0 0 24 24"><path d="M10 13a5 5 0 0 0 7.54.54l2.2-2.2a5 5 0 0 0-7.08-7.08l-1.26 1.26" /><path d="M14 11a5 5 0 0 0-7.54-.54l-2.2 2.2a5 5 0 0 0 7.08 7.08l1.26-1.26" /></svg></span><p>钱包地址</p><strong>0x8f3A...91c2</strong><small>以太坊兼容网络</small></article>
      ...
      <section class="wallet-grid">
        <article class="table-card">
          <div class="table-toolbar">
            ...
            <button type="button" @click="typeFilter = 'all'"><svg viewBox="0 0 24 24"><path d="M21 12a9 9 0 1 1-2.64-6.36" /><path d="M21 4v6h-6" /></svg>刷新</button>
          </div>
          <table>
            <colgroup>
              <col class="col-type" />
          ...
          <footer><label>每页显示：<select><option>10</option></select></label><div><button>‹</button><button class="active">1</button><button>2</button><button>3</button><span>...</span><button>12</button><button>›</button></div><span>共 12 条</span></footer>
        </article>
        <aside class="stats-card">
          <h2>近期统计</h2><p class="month">2026年05月</p>
          <div class="stat-item income"><i>↓</i><span>本月收入</span><strong>+125 <em>EDU</em></strong><small>3 笔交易</small></div>
          <div class="stat-item expense"><i>↑</i><span>本月支出</span><strong>-55 <em>EDU</em></strong><small>2 笔交易</small></div>
          <div class="stat-item count"><i>▤</i><span>最近交易数</span><strong>5</strong><small>最近 7 天</small></div>
          <p class="updated">统计更新于 2026-05-21 14:30</p>
        </aside>
      </section>
...
const transactions = [
  { kind: 'mint', label: '铸造 (Mint)', arrow: '↓', amount: 100, from: '0x0000...0000', to: '0x8f3A...91c2', block: '21034567', hash: '0xabc1...def234', time: '2026-05-20 10:15:22', group: 'mint' },
  { kind: 'receive', label: '接收 (Receive)', arrow: '↓', amount: 20, from: '0x3B1C...7D22', to: '0x8f3A...91c2', block: '21033211', hash: '0x7e2a...8bd901', time: '2026-05-19 16:42:10', group: 'in' },
  { kind: 'send', label: '发送 (Send)', arrow: '↑', amount: -5, from: '0x8f3A...91c2', to: '0x2C4D...B1F0', block: '21031890', hash: '0x9c33...a7b112', time: '2026-05-19 11:07:35', group: 'out' },
  { kind: 'receive', label: '接收 (Receive)', arrow: '↓', amount: 5, from: '0xA12E...44F8', to: '0x8f3A...91c2', block: '21030105', hash: '0xbf88...c3d445', time: '2026-05-18 20:33:48', group: 'in' },
  { kind: 'burn', label: '销毁 (Burn)', arrow: '♨', amount: -50, from: '0x8f3A...91c2', to: '0x0000...0000', block: '21028012', hash: '0x1d77...e6f889', time: '2026-05-18 09:21:14', group: 'burn' },
]
const filteredTransactions = computed(() => typeFilter.value === 'all' ? transactions : transactions.filter((tx) => tx.group === typeFilter.value || tx.kind === typeFilter.value))
</script>
